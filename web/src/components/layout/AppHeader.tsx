...
export function AppHeader({ title }: { title?: string }) {
  ...
  return (
    <>
      {/* Mobile top bar */}
      <header className="md:hidden flex min-w-0 justify-between items-center w-full px-margin-mobile min-h-14 py-2 bg-surface/80 backdrop-blur-xl border-b border-outline-variant sticky top-0 z-40 gap-3">
